          ...
          <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
            ...
            <RevealWrapper delay={0.1}>
              <p className="mt-6 text-xl leading-8 text-gray-600">
                Descubre la esencia de K’affa Kaffeé a través de nuestro
                talentoso equipo. Estamos aquí para responder tus preguntas,
                compartir nuestra pasión por el café y asegurarnos de que tu
