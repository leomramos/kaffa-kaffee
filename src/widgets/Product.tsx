          ...
          <div className="flex items-center">
            ...
            <RevealWrapper delay={0.1}>
              <div className="ml-4 border-l border-gray-300 pl-4">
                <h2 className="sr-only">Calificaciones</h2>
              ...
              >
                ...
                <div className="mt-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
                  {flavors.map((flavor, index) => (
                    <RevealWrapper key={flavor.name} delay={index * 0.05}>
                      <RadioGroup.Option
                        as="div"
                        value={flavor}
                        className={({ active }) =>
              ...
              >
                ...
                <div className="mt-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
                  {sizes.map((size, index) => (
                    <RevealWrapper key={size.name} delay={index * 0.1}>
                      <RadioGroup.Option
                        as="div"
                        key={size.name}
                        value={size}
              ...
              >
                ...
                <div className="mt-1 grid grid-cols-1 gap-4 sm:grid-cols-2">
                  {types.map((type, index) => (
                    <RevealWrapper key={type.name} delay={index * 0.1}>
                      <RadioGroup.Option
                        as="div"
                        key={type.name}
                        value={type}
